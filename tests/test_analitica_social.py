...
def _df_posts(n: int = 60) -> pd.DataFrame:
    ...
    bases = [
        'El desabasto de agua es grave, las pipas no llegan hoy @agua_tlalpan',
        'La inseguridad aumenta con los robos en el transporte publico @policia_tlalpan',
        'excelente servicio de la policia en mi colonia hoy gracias @gobtlalpan',
    ]
    filas = []
    for i in range(n):
